...
[x_mpc, u_mpc, avg_exec_time_mpc] = MPC(x1);
...
[x_safe, u_safe, Q_safe, avg_exec_time_lmpc] = LMPC(x1, x_mpc, u_mpc);
...
data_to_save = sprintf('lmpc_data_%d.mat',data.n_save);
save(data_to_save,'x_safe','u_safe','Q_safe','data','avg_exec_time_mpc','avg_exec_time_lmpc');

%% ========== Plots ==========
close all
%pause
LMPC_plot_results_fun(data.n_save, data.print_figures)
