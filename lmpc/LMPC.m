function [x_safe, u_safe, Q_safe, avg_exec_time] = LMPC(x1, x_first, u_first)
...
% ===== Optimizer object (2) =====
params_in = {x1_in, A_op, B_op, c_op, A_ch_op, b_ch_op, d_r_op};
...
for j = 1:1:data.n_iter
	...
	while x1(11) < data.L_track
		...
		tic
		u1 = lmpc({x1, A, B, c, A_ch, b_ch, d_r});
		curr_exec_time = toc;
